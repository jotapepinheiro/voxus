...
/**
 * @Schema(title="Localizações Paginate", description="Lista de Localizações com Paginação")
 *
 * @package App\Http\Responses\Locations
 */
class LocationsPaginateResponse
{
    /**
    ...
    /**
     * @Property(type="array", @Items(ref="#/components/schemas/LocationProperty"))
     *
     * @var array
     */
    public $data = [];
