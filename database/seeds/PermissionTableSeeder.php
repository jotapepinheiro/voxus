...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $permissions = [
            ...
            /* 13 */ ['name' => 'location-list','display_name' => 'Listar Localizações','description' => 'Visualizar Localizações'],
            /* 14 */ ['name' => 'location-create','display_name' => 'Criar Localizações','description' => 'Criar Novas Localizações'],
            /* 15 */ ['name' => 'location-edit','display_name' => 'Editar Localizações','description' => 'Editar Localizações'],
            /* 16 */ ['name' => 'location-delete','display_name' => 'Deletar Localizações','description' => 'Deletar Localizações'],
       ];
